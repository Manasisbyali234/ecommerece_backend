...
export const publicUser = (user) => ({ id: user._id, fullName: user.fullName, email: user.email, phone: user.phone, role: user.role, profile: user.profile, addresses: user.addresses, hasPassword: Boolean(user.passwordHash) });
